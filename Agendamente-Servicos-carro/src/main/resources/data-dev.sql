-- ============================================================
-- Dados de seed para desenvolvimento local (H2)
-- Sem ALTER SEQUENCE (não existe em H2 com IDENTITY strategy)
-- ============================================================
...
-- Funcionario (joined table — só o id)
